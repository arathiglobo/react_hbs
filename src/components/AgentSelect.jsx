...
export default function AgentSelect({
  ...
  return (
    <Select
      ...
      // Render the menu in a body-level portal so it overlays sibling
      // controls (e.g. the "Search" button below) and is never clipped by
      // a parent card's overflow. menuPosition="fixed" keeps it anchored
      // to the control while scrolling.
