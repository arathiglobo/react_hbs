        ...
        >
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h5 className="mb-0 text-dark fw-semibold">Custom Booking</h5>
            </div>
            ...
            >
              ...
              <Card.Body style={{ padding: "1.5rem 1rem 1rem" }}>
                {/* Toolbar row 1: pills + Time Period + page size + search */}
                              ...
                              <tr key={booking.packageCode || index}>
                                ...
                                <td className="text-center">
                                  <button
                                    ...
                                    onClick={() =>
                                      navigate(
                                        `/booking-details/custom-booking/${booking.customBookingId || booking.bookingId || booking.id}`,
