...
// Shared status badge palette (same as LongStayBookingList). Extra entries
// cover the gov-employee Notification statuses that don't appear there.
const STATUS_META = {
...
export default function GovEmployeeBookingList() {
    ...
    if (bookingType !== "all") {
      ...
      list = list.filter((b) => {
        ...
        switch (bookingType) {
          ...
          case "invoiced":
            // No invoice concept on the gov-employee payload — filter to empty.
            return (
              !b.cancelled &&
  ...
  // page keeps its own "Confirmed / Cancelled" composite label.
