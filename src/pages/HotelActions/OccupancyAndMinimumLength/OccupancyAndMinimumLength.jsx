...
// nothing is written back to the form until "Apply" is clicked (Cancel
// discards the draft). Value in/out uses the same "YYYY-MM-DDTHH:mm"
// string the rest of this page already works with.
...
const DateTimeApplyPicker = ({
  ...
  // inside the viewport (the popup is portaled to <body>, so it escapes the
  // modal's scroll/overflow clipping).
  const computePos = () => {
