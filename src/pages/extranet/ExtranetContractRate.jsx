...
export default function ExtranetContractRate() {
  ...
  const handleCreate = () => {
    navigate(`/extranet/${id}/create-contract-rate`);
  };

  const handleEdit = (rateId) => {
    navigate(`/extranet/${id}/edit-contract-rate/${rateId}`);
  };

  const handleCopy = (rateId) => {
    navigate(`/extranet/hotel/${id}/contract-rate/${rateId}/copy`);
  };
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 p-4">
          <div className="d-flex align-items-center gap-3 mb-3">
            ...
            <h3 className="mb-0">Extranet Contract Rates</h3>
          </div>
