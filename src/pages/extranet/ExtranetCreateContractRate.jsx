...
export default function ExtranetCreateContractRate() {
        ...
        <main className="flex-grow-1 p-4">
          <Container fluid>
            <div className="d-flex justify-content-between align-items-center mb-4">
              <Button variant="outline-secondary" onClick={() => navigate(`/extranet/${id}/contract-rate`)}>
                <FaArrowLeft className="me-2" /> Back
              </Button>
              <h4 className="fw-semibold text-dark mb-0">
                Create Extranet Contract Rate
              </h4>
