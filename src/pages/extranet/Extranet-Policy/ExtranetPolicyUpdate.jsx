...
const ExtranetPolicyUpdate = () => {
  ...
  const normaliseDateTime = (value) => {
    if (!value) return "";
    // If it starts with valid ISO format YYYY-MM-DDTHH:mm, extract just that part
    // This handles strings with seconds, milliseconds, or extra colons like ":00:00"
        ...
        <main className="flex-grow-1 p-4">
          <Container fluid>
            ...
            <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
              ...
              <h4 className="fw-semibold text-dark mb-0">Update Extranet Policy Details</h4>
            </div>
...
export default ExtranetPolicyUpdate;
