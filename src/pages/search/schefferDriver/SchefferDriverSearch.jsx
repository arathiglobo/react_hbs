...
export const SchefferDriverSearch = () => {
  ...
  // Airports. Sourced from the new /api/scheffer-search/lookup endpoint, which
    ...
    try {
      ...
      const mappedResults = Array.isArray(response.data)
        ? response.data.map((cab, index) => ({
            ...
            // Additions surfaced by the new /api/scheffer-search/search endpoint.
