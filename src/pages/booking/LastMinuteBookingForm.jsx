          ...
          <Modal.Body className="px-4 py-3 bg-light">
            <div className="border rounded-3 bg-white shadow-sm p-3">
              ...
              <Row className="gy-2">
                ...
                <Col xs={12}>
                  <div className="p-3 rounded bg-white border text-center mt-2">
                    <h6 className="mb-1 fw-bold text-muted">Total Price</h6>
                    <h4 className="mb-0 text-danger fw-bold">
                      {formatPrice(payableTotal)} for {totalRoomCount}{" "}
