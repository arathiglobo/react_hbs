...
export default function AdminDashboard() {
  ...
  const actions = [
    ...
    { label: 'Add New Agent',      icon: 'agent',    to: '/registration/agent' },
    { label: 'Accommodation',      icon: 'booking',  to: '/new-booking/hotel' },
    { label: 'Transfer',           icon: 'transfer', to: '/new-booking/cab' },
    { label: 'Tours & Activities', icon: 'tour',     to: '/new-booking/tours-and-activities' },
    { label: 'Agent Account',      icon: 'account',  to: '/incentive/config' },
  ];
