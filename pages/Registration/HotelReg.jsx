...
const HotelReg = () => {
  ...
  const addRoom = () => {
    setFormData(prev => ({
      ...
      rooms: [
        ...
        {
          roomCategoryId: "",
          roomTypes: [], // Array of room types for this category
          roomName: "",
        }
      ]
    }));
    ...
    setFormData(prev => ({
      ...
      rooms: prev.rooms.map((room, i) => {
        if (i === index) {
          ...
          // If room category is changed, clear room types and load new ones
  ...
  const calculateCompletion = () => {
    const totalFields = 12; // Basic required fields
          ...
          <Container fluid>
            ...
            <Card.Body>
              <Form onSubmit={handleSubmit}>
                <Accordion defaultActiveKey="hotel-info" className="hotel-registration-accordion">
                  {/* Hotel Information Section */}
                  <Accordion.Item eventKey="hotel-info" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        <div className="bg-primary text-white rounded-circle p-2 me-3">
                          <FaHotel size={20} />
                        </div>
                        <div>
                          <h5 className="mb-0 text-primary">Hotel Information</h5>
                          <small className="text-muted">Basic hotel details and settings</small>
                        </div>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="location-info" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h5 className="mb-0 text-success">Location Information</h5>
                          <small className="text-muted">Hotel address and geographical details</small>
                        </div>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="contact-details" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1">
                          <h5 className="mb-0 text-info">Contact Details</h5>
                          <small className="text-muted">Hotel contact information and personnel</small>
                        </div>
                        <Badge bg="info" className="fs-6 px-3 py-2">
                          {formData.contactDetails.length} Contact{formData.contactDetails.length !== 1 ? 's' : ''}
                        </Badge>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="bank-details" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1">
                          <h5 className="mb-0 text-dark">Bank Details</h5>
                          <small className="text-muted">Hotel banking and payment information</small>
                        </div>
                        <Badge bg="dark" className="fs-6 px-3 py-2">
                          {formData.bankDetails.length} Bank{formData.bankDetails.length !== 1 ? 's' : ''}
                        </Badge>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  {/* Week Days Section */}
                  <Accordion.Item eventKey="week-days" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        <div className="bg-secondary text-white rounded-circle p-2 me-3">
                          <FaCalendarAlt size={20} />
                        </div>
                        <div>
                          <h5 className="mb-0 text-secondary">Working Days & Weekends</h5>
                          <small className="text-muted">Configure hotel operational days</small>
                        </div>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  {/* Amenities Section */}
                  <Accordion.Item eventKey="amenities" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        <div className="bg-info text-white rounded-circle p-2 me-3">
                        ...
                        <div className="flex-grow-1">
                          <h5 className="mb-0 text-info">Amenities</h5>
                          <small className="text-muted">Hotel facilities and services</small>
                        </div>
                        <Badge bg="info" className="fs-6 px-3 py-2">
                  ...
                  {/* Rooms Section */}
                  <Accordion.Item eventKey="rooms" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1">
                          <h5 className="mb-0 text-warning">Room Configuration</h5>
                          <small className="text-muted">Room categories and their types</small>
                        </div>
                        <Badge bg="warning" className="fs-6 px-3 py-2">
                          {formData.rooms.length} Categor{formData.rooms.length !== 1 ? 'ies' : 'y'}
                        </Badge>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
                          ...
                          <Card.Header className="bg-light border-0">
                            <div className="d-flex justify-content-between align-items-center">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  <h6 className="mb-0 text-warning">Room Category {roomIndex + 1}</h6>
                  ...
                  <Accordion.Item eventKey="terms-conditions" className="mb-3 border-0 shadow-sm">
                    <Accordion.Header className="bg-light border-0 rounded-3">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1">
                          <h5 className="mb-0 text-danger">Terms and Conditions</h5>
                          <small className="text-muted">Hotel policies and terms</small>
                        </div>
                        <Badge bg="danger" className="fs-6 px-3 py-2">
                          {formData.termsAndConditions.length} Term{formData.termsAndConditions.length !== 1 ? 's' : ''}
                        </Badge>
                      </div>
                    </Accordion.Header>
                    <Accordion.Body>
